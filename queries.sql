...
(6, 2, '2017-11-06','2018-04-05','2018-03-26', 'Прочитать Красавчик Марселя Эме', NULL),
(7, 2, '2018-08-06', NULL, '2018-03-26', 'Прочитать Humans of New York', NULL),
(8, 2, '2018-08-06', NULL, '2018-03-27', 'Выбрать макет', NULL),
(9, 2, '2018-08-11', NULL, '2018-03-26', 'Сходить на концерт Radiohead', NULL),
(9, 2, '2018-03-06',NULL, '2018-11-26', 'Отправить заявку в экспедицию на Амазонку', NULL),
(6, 2, '2018-09-05', NULL, '2018-10-03', 'Прочитать Женщину в Белом Уилки Коллинза', NULL);
